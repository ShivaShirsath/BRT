-- V10__change_sales_ids_to_uuid.sql
-- Migrate sale_patti and its children from bigint ids to uuid
...
-- 2. Drop primary key constraint and default on sale_patti
