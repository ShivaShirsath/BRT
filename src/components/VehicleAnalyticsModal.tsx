...
export function VehicleAnalyticsModal({ open, onClose, vehicleNo }: VehicleAnalyticsModalProps) {
      ...
      <DialogContent className="max-w-5xl max-h-[90vh] overflow-y-auto p-6">
        <DialogHeader className="border-b pb-4 mb-4">
          <div className="flex items-center justify-between">
            <div>
              <DialogTitle className="text-xl font-extrabold tracking-tight">Vehicle Analytics Dashboard</DialogTitle>
              <DialogDescription className="text-xs text-muted-foreground mt-1">
                Past purchase and sales records associated with this vehicle.
              </DialogDescription>
            </div>
            <div className="bg-[#1e3a8a] text-white px-4 py-1.5 rounded-full text-sm font-bold tracking-wider mr-6">
              {vehicleNo}
            </div>
          </div>
        </DialogHeader>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
              <Card className="bg-gradient-to-br from-blue-50 to-white dark:from-slate-900 dark:to-card border-l-4 border-blue-500">
                <CardContent className="p-4 flex flex-col justify-between">
                  ...
                  <span className="text-2xl font-extrabold text-blue-600 dark:text-blue-400 mt-1">{filteredMetrics.trips}</span>
                </CardContent>
              </Card>
                  ...
                  <TableBody>
                    {filteredTransactions.map((tx) => (
                      <TableRow key={tx.id} className="hover:bg-muted/50 transition-colors">
                        ...
                        <TableCell className="font-semibold text-xs text-slate-800 dark:text-slate-200">{tx.partyName}</TableCell>
